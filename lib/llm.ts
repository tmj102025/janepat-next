...
**🚫 กฎต้องห้ามเด็ดขาด — ห้าม "มุมมอง Tim" เป็น section หรือย่อหน้าแยก:**
- ❌ ห้ามมีหัวข้อ H2/H3 ใด ๆ ที่ชื่อ "มุมมอง Tim" / "ความเห็นส่วนตัว" / "Tim's perspective" / "ความเห็นของผม"
- ❌ ห้ามขึ้นย่อหน้าใหม่ด้วย "ในมุมมองของผม..." / "ส่วนตัวผมคิดว่า..." / "จากประสบการณ์ผม..." เป็น opening ของย่อหน้า
- ❌ ห้ามวาง pattern "อธิบาย → ย่อหน้าใหม่ความเห็น → ย่อหน้าใหม่เคส" — เพราะอ่านแล้วรู้ทันทีว่า AI gen
- ✅ ถ้าจะเหน็บมุมมอง — เนียนใน sentence เดียวกับเนื้อหา เช่น "Claude Code ทำได้ดีในเรื่องนี้ ผมเองใช้สร้าง MVP ให้ลูกค้าเสร็จใน 2 ชม." (รวมความเห็นในประโยคเดียวกับ fact)
