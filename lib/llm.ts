...
const OUTPUT_INSTRUCTIONS = `**Output: JSON only — schema:**
{
  ...
  "content_md": "บทความเต็ม markdown ตามโครง: ย่อหน้าเปิด 1-2 ประโยค (ไม่มี heading 'Hook') → bullet 3-5 ข้อสรุปประเด็น (ไม่มี heading 'สรุปสั้น') → H2 sections 4-6 (heading ภาษาไทยที่อธิบายเนื้อหา ไม่ใช่ generic label) → ปิด ## สรุป + bullet 'ขั้นตอนต่อไป' (ห้าม Action Items ภาษาอังกฤษ). ห้ามใส่ iframe/รูป. 1000-1400 คำ",
