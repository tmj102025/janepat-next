...
- **ห้าม external link** ที่นำคนออกจาก janepat.com
- **ห้าม internal CTA / cross-link / "อ่านบทความอื่น"** ในเนื้อบทความเด็ดขาด — link reference อยู่ใน FB comment แล้ว ไม่ต้องชวนอ่านต่อในตัวบทความ
...
6. **ห้ามใส่ <iframe>, รูป, external link, internal link ใดๆ** ใน content_md
7. **ห้ามปิดท้ายด้วย CTA ชวนอ่านบทความอื่น / ชวนเข้า janepat.com / "ขยายศักยภาพ AI ของคุณ" / "ติดตามต่อที่..."** เด็ดขาด — link อยู่ใน FB comment แล้ว ปิดท้ายแค่ ## สรุป + bullet ขั้นตอนต่อไป จบ
...
**🚫 ประโยคปิดท้ายแบบ self-promo ห้ามใช้เด็ดขาด** (link อยู่ใน FB comment ไม่ต้อง CTA ในเนื้อ):
- ❌ "อ่านบทความอื่น ๆ ของเราเกี่ยวกับ... ที่ janepat.com"
- ❌ "อ่านบทความอื่นเพิ่มเติมที่ janepat.com"
- ❌ "ติดตามบทความอื่น ๆ ที่ janepat.com"
- ❌ "เพื่อขยายศักยภาพ AI ของคุณต่อไป"
- ❌ "เข้าไปดูที่หน้าเว็บ" / "คลิกอ่านต่อที่..."
ปิดท้ายจบที่ bullet "ขั้นตอนต่อไป" ของส่วนสรุป — ห้ามมีย่อหน้า/ประโยค CTA ตามหลัง
...
const OUTPUT_INSTRUCTIONS = `**Output: JSON only — schema:**
{
  ...
  "content_md": "บทความเต็ม markdown ตามโครง: ย่อหน้าเปิด 1-2 ประโยค (ไม่มี heading 'Hook') → bullet 3-5 ข้อสรุปประเด็น (ไม่มี heading 'สรุปสั้น') → H2 sections 4-6 (heading ภาษาไทยที่อธิบายเนื้อหา ไม่ใช่ generic label) → ปิด ## สรุป + bullet 'ขั้นตอนต่อไป' (ห้าม Action Items ภาษาอังกฤษ). ห้ามใส่ iframe/รูป/link. **ห้าม CTA ปิดท้ายแบบ 'อ่านบทความอื่น...ที่ janepat.com' / 'ขยายศักยภาพ AI ของคุณ' / 'ติดตามต่อที่...'** — link อยู่ใน FB comment แล้ว. ห้าม hype/exaggerated. 1000-1400 คำ",
  "fb_caption": "FB caption เนื้อหาครบเหมือนอ่านบทความเต็มบน FB — เอาเนื้อหาจาก content_md มาเรียบเรียงใหม่ในโครง mobile-readable. ห้ามมีลิงก์ ห้ามใช้ markdown (FB ไม่ render). โครง: 🤖 หัวข้อใหญ่ → ย่อหน้าเปิด hook 2-3 บรรทัด → 📌 หัวข้อย่อย 1 + ย่อหน้าเนื้อหา → 📌 หัวข้อย่อย 2 + ย่อหน้าเนื้อหา (4-6 sections) → ย่อหน้าสรุป 2-3 บรรทัด → #hashtag 4-5 ตัว. ใช้ ✅ bullets ภายใน section เมื่อเป็น list. เว้นบรรทัดว่างทุกครั้งระหว่าง paragraph และก่อน 📌. ความยาว 2500-4500 ตัวอักษร. **ห้ามใส่ 'อ่านเต็ม', 'ลิงก์ใน comment', 'อ่านต่อ', 'คลิกที่ลิงก์', 'ดูที่หน้าเว็บ' หรือ CTA นำผู้อ่านออกจาก FB ใด ๆ**. ห้าม hype ('ผมลองแล้ว', '🔥', 'เปลี่ยนเกม'). curated: mention creator 1 ครั้งใน opener (เช่น 📌 จากคลิปล่าสุดของ X). emoji ใช้สวยงามไม่รก: 🤖🧠⚙️🛠️📊📌📈🔍✅⚡💡 — ห้าม 🔥💯🚀.",
