...
export default async function HomePage() {
  ...
  return (
    <>
          ...
          <div className="grid gap-14 lg:grid-cols-[1.5fr_1fr] lg:items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-teal-400/30 bg-teal-400/10 px-3 py-1 text-[11px] font-mono uppercase tracking-widest text-teal-300">
                <span className="h-1.5 w-1.5 rounded-full bg-teal-400 live-pulse" />
                AI Expert · ภาษาไทย · 28.8K subs
              </div>

              <h1 className="mt-7 text-[44px] font-semibold leading-[1.02] tracking-[-0.025em] text-white md:text-[76px] lg:text-[88px]">
                เรียนรู้
                <br />
              ...
              <p className="mt-7 max-w-xl text-[16px] leading-[1.85] text-zinc-300 md:text-[18px]">
                ...
                <strong className="text-white">1,200+</strong> คน
              </p>

              <div className="mt-10 flex flex-wrap gap-3">
                <Link
                  href="/ai"
                  className="inline-flex items-center gap-2 rounded-full bg-teal-400 px-6 py-3.5 text-[14px] font-semibold text-zinc-900 transition hover:bg-teal-300 hover:scale-[1.03]"
                >
                  เริ่มเรียน AI ฟรี
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="inline-flex items-center gap-2 rounded-full border border-white/15 px-6 py-3.5 text-[14px] text-white transition hover:border-teal-400/40"
                >
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="relative rounded-3xl border border-white/[0.08] bg-[#0c0d0f]/80 backdrop-blur p-8">
                <div className="text-[10px] font-mono uppercase tracking-[0.3em] text-teal-300/70">
                  Live activity
                </div>
                <div className="mt-5 space-y-4">
                  ...
                  <ActivityItem
                    badge="NEW"
                    badgeColor="bg-teal-400 text-zinc-900"
                    title="n8n + Claude Workflow"
                    meta="บทความใหม่ · 12 นาที"
                  />
                  <ActivityItem
                    badge="HOT"
                    badgeColor="bg-amber-300 text-zinc-900"
                    title="AI Marketing Stack 2026"
                    meta="2.4k views อาทิตย์นี้"
                  />
                </div>

                <div className="mt-8 rounded-2xl border border-white/[0.08] bg-[#070708] p-5">
                  <div className="flex items-center gap-3">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-300 to-amber-300 font-black text-zinc-900 text-xl">
                      T
                    </div>
                    <div>
                      <div className="text-[13px] font-semibold text-white">Tim Janepat</div>
                      <div className="text-[11px] text-zinc-500">AI Expert · Bangkok</div>
                    </div>
                  </div>
                  <div className="mt-4 grid grid-cols-2 gap-2 text-[11px] font-mono">
                    <div className="rounded-lg bg-teal-400/10 border border-teal-400/20 px-2 py-1.5 text-teal-300 text-center">
                      Gemini Cert
                    </div>
                    <div className="rounded-lg bg-amber-300/10 border border-amber-300/20 px-2 py-1.5 text-amber-300 text-center">
                      AiCEO Founder
                    </div>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-6 lg:grid-cols-[1fr_2fr] lg:items-end">
            <div>
              ...
              <h2 className="mt-3 text-[32px] font-bold tracking-[-0.01em] text-white md:text-[52px] leading-[1.05]">
                เลือกหัวข้อ AI<br />ที่อยากเรียนรู้
              </h2>
            </div>
            <p className="text-[15px] leading-[1.85] text-zinc-400 max-w-2xl lg:justify-self-end">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {AI_CATEGORIES.map((cat, idx) => (
              <Link
                key={cat.slug}
                href={`/ai/${cat.slug}`}
                className="group card-glow rounded-2xl border border-white/[0.08] bg-[#0f1011] p-7 transition hover:bg-[#101214] hover:-translate-y-1"
              >
                ...
                <h3 className="mt-5 text-[20px] font-bold text-white tracking-tight">{cat.name}</h3>
                ...
                <div className="mt-7 flex items-center justify-between text-[12px]">
                  <span className="text-teal-300 transition group-hover:translate-x-1">
                    อ่านเพิ่ม →
                  </span>
                  <span className="text-zinc-600 font-mono">เร็ว ๆ นี้</span>
                </div>
              </Link>
            ))}
          </div>
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {featuredPosts.map((post) => (
                <Link
                  ...
                  className="group rounded-2xl border border-white/[0.08] bg-[#0f1011] overflow-hidden transition hover:border-teal-400/30 hover:-translate-y-1"
                >
                  {post.cover && (
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="mt-3 text-[18px] font-bold text-white line-clamp-2">
                      {post.title_th}
                    </h3>
                    <p className="mt-2 text-[14px] leading-[1.7] text-zinc-400 line-clamp-3">
                      {post.excerpt}
                    </p>
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {AI_CATEGORIES.slice(0, 3).map((cat) => (
                <Link
                  key={cat.slug}
                  href={`/ai/${cat.slug}`}
                  className="group rounded-2xl border border-dashed border-white/10 bg-[#0a0a0c] p-7 hover:border-teal-400/30 transition"
                >
                  ...
                  <div className="mt-4 text-[11px] font-mono uppercase tracking-widest text-teal-300">
                    {cat.name}
                  </div>
      ...
      {/* Services CTA */}
      <section className="relative border-t border-white/[0.06] bg-[#0a0a0c] px-6 py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-[32px] font-bold tracking-tight text-white md:text-[52px] leading-[1.02]">
                ทำงาน AI<br />
                <span className="text-stroke">ร่วมกับ TIM</span>
              </h2>
              <p className="mt-5 text-[15px] leading-[1.85] text-zinc-400 max-w-md">
                ตั้งแต่ brand deal, AI consulting, อบรมองค์กร ไปจนถึงคอร์สออนไลน์ใน AiCEO Academy
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  href="/services"
                  className="inline-flex items-center rounded-full bg-teal-400 px-6 py-3.5 text-[14px] font-semibold text-zinc-900 hover:bg-teal-300 hover:scale-[1.03] transition"
                >
                  ดูบริการทั้งหมด
                </Link>
                <Link
                  href="/contact"
                  className="inline-flex items-center rounded-full border border-white/15 px-6 py-3.5 text-[14px] text-white hover:border-teal-400/40 transition"
                >
                  ติดต่อ Tim
                </Link>
              </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <ServiceCard
                num="04"
                title="Online Course"
                desc="คอร์สเต็มที่ AiCEO Academy — Lifetime access"
                tone="emerald"
              />
            </div>
          </div>
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div className="border-l-2 border-white/[0.08] pl-4">
      <div className="text-[28px] font-bold text-white md:text-[34px] leading-none">{value}</div>
...
function ActivityItem({
  ...
  return (
    <div className="flex items-start gap-3 rounded-xl border border-white/[0.04] bg-white/[0.02] p-3">
      <span className={`shrink-0 rounded-md px-2 py-0.5 text-[9px] font-bold uppercase tracking-widest text-white ${badgeColor}`}>
        {badge}
      </span>
...
function ServiceCard({
  ...
  return (
    <div className="rounded-2xl border border-white/[0.08] bg-[#0f1011] p-6 transition hover:border-teal-400/20">
